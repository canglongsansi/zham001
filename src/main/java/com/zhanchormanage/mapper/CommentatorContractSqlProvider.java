...
import com.zhanchormanage.model.CommentatorContractExample.Criteria;
import com.zhanchormanage.model.CommentatorContractExample.Criterion;
import com.zhanchormanage.model.CommentatorContractExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class CommentatorContractSqlProvider {

    public String countByExample(CommentatorContractExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("commentator_contract");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(CommentatorContractExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("commentator_contract");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(CommentatorContract record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("commentator_contract");
    ...
    public String selectByExample(CommentatorContractExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CommentatorContract record = (CommentatorContract) parameter.get("record");
        CommentatorContractExample example = (CommentatorContractExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("commentator_contract");
    ...
    public String updateByPrimaryKeySelective(CommentatorContract record) {
        SQL sql = new SQL();
        sql.UPDATE("commentator_contract");
    ...
    protected void applyWhere(SQL sql, CommentatorContractExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
