...
import com.zhanchormanage.model.ArtistBrokerageContractExample.Criteria;
import com.zhanchormanage.model.ArtistBrokerageContractExample.Criterion;
import com.zhanchormanage.model.ArtistBrokerageContractExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ArtistBrokerageContractSqlProvider {

    public String countByExample(ArtistBrokerageContractExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("artist_brokerage_contract");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ArtistBrokerageContractExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("artist_brokerage_contract");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ArtistBrokerageContract record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("artist_brokerage_contract");
    ...
    public String selectByExample(ArtistBrokerageContractExample example) {
        SQL sql = new SQL();
        ...
        sql.FROM("artist_brokerage_contract");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ArtistBrokerageContract record = (ArtistBrokerageContract) parameter.get("record");
        ArtistBrokerageContractExample example = (ArtistBrokerageContractExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("artist_brokerage_contract");
    ...
    public String updateByPrimaryKeySelective(ArtistBrokerageContract record) {
        SQL sql = new SQL();
        sql.UPDATE("artist_brokerage_contract");
    ...
    protected void applyWhere(SQL sql, ArtistBrokerageContractExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
