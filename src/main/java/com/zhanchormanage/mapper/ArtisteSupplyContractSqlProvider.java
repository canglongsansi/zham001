...
import com.zhanchormanage.model.ArtisteSupplyContractExample.Criteria;
import com.zhanchormanage.model.ArtisteSupplyContractExample.Criterion;
import com.zhanchormanage.model.ArtisteSupplyContractExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ArtisteSupplyContractSqlProvider {

    public String countByExample(ArtisteSupplyContractExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("artiste_supply_contract");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ArtisteSupplyContractExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("artiste_supply_contract");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ArtisteSupplyContract record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("artiste_supply_contract");
    ...
    public String selectByExample(ArtisteSupplyContractExample example) {
        SQL sql = new SQL();
        ...
        sql.FROM("artiste_supply_contract");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ArtisteSupplyContract record = (ArtisteSupplyContract) parameter.get("record");
        ArtisteSupplyContractExample example = (ArtisteSupplyContractExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("artiste_supply_contract");
    ...
    public String updateByPrimaryKeySelective(ArtisteSupplyContract record) {
        SQL sql = new SQL();
        sql.UPDATE("artiste_supply_contract");
    ...
    protected void applyWhere(SQL sql, ArtisteSupplyContractExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
